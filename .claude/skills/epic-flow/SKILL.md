...
**The folder layout is `framework/task-board.md`'s to define** - it owns where
work lives for every skill, and a second copy here would drift from it. Read it
there; the stages below say what each document must CONTAIN.
