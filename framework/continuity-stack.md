...
| reference layer - `mental-model.md` (apex) · `portfolio/<front>/_front.md` (hub) · `portfolio/<front>/[<project>/]<project>.md` (spoke) | **Large-picture + git-memory** - slow-changing structural truth; the spoke is the sub-agent hand-off unit | when a project's shape / git facts change | opening a front · dispatching a sub-agent |
